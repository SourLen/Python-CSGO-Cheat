...
dwEntityList =81399124
dwGlowObjectManager =86938440
m_iGlowIndex =42040
m_iTeamNum =244
dwForceJump =86289588
dwLocalPlayer =14193324
m_fFlags =260
dwForceAttack =52241088
...
m_iHealth =256
dwViewMatrix =81339988
m_dwBoneMatrix = 9896
dwClientState_ViewAngles =19856
m_vecOrigin =312
m_vecViewOffset =264
dwbSendPackets =881642
dwInput =85926712
...
if __name__ == "__main__":
    ...
    ui.setupUi( Dialog )
    Dialog.show()
    t1 = threading.Thread(target= ui.change_skin)

    t2 = threading.Thread(target = ui.main)
    #t1.start()
    t2.start()
